...
比如，你从云服务商购买了一个 MySQL 实例，你可以直接把实例的访问地址配置到该组件的 Servcie 下。
...
mysql:
  ...
  computed:
    default:
      ...
      # 如果主机清单中存在该组件，并且对应的主机列表不为空，则从主机列表中取出一条作为 host 值
...
elasticsearch:
  computed:
    default:
      ...
      host: 9.134.125.68
      port: 9200
      addr: 9.134.125.68:9200
      endpoints:
        - 9.134.125.68:9200
        - 9.134.125.67:9200
        - 9.134.125.69:9200
      urls:
        - http://9.134.125.68:9200
        - http://9.134.125.67:9200
        - http://9.134.125.69:9200
    cluster:
      scheme: http
      host: 9.134.125.68
      port: 9300
      addr: 9.134.125.68:9300
      endpoints:
        - 9.134.125.69:9300
        - 9.134.125.68:9300
        - 9.134.125.67:9300
      urls:
        - http://9.134.125.69:9300
        - http://9.134.125.68:9300
        - http://9.134.125.67:9300
```
